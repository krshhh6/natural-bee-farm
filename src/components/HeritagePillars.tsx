...
export const HeritagePillars: React.FC = () => {
  ...
  return (
    <section className="py-10 sm:py-20 bg-[#FEFDF5] dark:bg-[#1A1816] transition-colors border-t border-[#E7DFD3] dark:border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-8 lg:gap-10 text-center">
          {pillars.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center group cursor-pointer p-2.5 sm:p-4 rounded-2xl bg-white/60 dark:bg-[#201D19]/60 sm:bg-transparent border border-[#E7DFD3]/60 sm:border-none shadow-xs sm:shadow-none transition-all duration-300 hover-lift">
